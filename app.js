...
th = cookieStoreTableHeadCell('SeaTac Airport');
tbody.appendChild(th);
...
th = cookieStoreTableHeadCell('Seattle Center');
tbody.appendChild(th);
...
th = cookieStoreTableHeadCell('Capitol Hill');
tbody.appendChild(th);
...
th = cookieStoreTableHeadCell('Alki');
tbody.appendChild(th);
